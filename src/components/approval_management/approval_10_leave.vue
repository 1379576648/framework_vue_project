  ...
  <div class="body_1">
    <el-tabs type="border-card">
      ...
      <el-tab-pane label="待办申请">
        <el-button @click="selectLeaveAll2()">重置</el-button>
        &nbsp;
        <el-input
            v-model="staffName"
            placeholder="根据申请人搜索"
        ...
        &nbsp;
        <el-button type="success" plain @click="selectLeaveAll()">搜索</el-button>
        <!--  表格 -->
        <el-table
            ref="filterTable1"
            row-key="date1"
        ...
        <div class="demo-pagination-block">
          <el-pagination
              ...
              next-text="下一页"
              prev-text="上一页"
              @size-change="selectLeaveAll()"
              @current-change="selectLeaveAll()"
              @prev-click="selectLeaveAll()"
              @next-click="selectLeaveAll()">
            prev-text="上一页"
            next-text="下一页"
            >
      ...
      <el-drawer v-model="drawer" title="I am the title" :with-header="false">
        <el-form ref="form" :model="details">
          ...
          <el-form-item label="请假类型：">
            <el-input v-model="details[0].leaveType" disabled></el-input>
          </el-form-item>
          ...
          <el-form-item label="请假结束时间：">
            <el-input v-model="details[0].leaveedate" disabled></el-input>
          </el-form-item>
          <el-form-item label="请假总时长：">
            <el-input v-model="details[0].leavetotaldate" disabled></el-input>
          </el-form-item>
      ...
      <el-tab-pane label="已办申请">
        <el-button @click="selectEndLeaveAll2()">重置</el-button>
        &nbsp;
        <el-input
            v-model="staffName1"
            placeholder="根据申请人搜索"
        ...
        &nbsp;
        <el-button type="success" plain @click="selectEndLeaveAll()">搜索</el-button>
        <el-table
            ref="filterTable"
            row-key="date"
            :data="tableData1"
        ...
        <el-drawer v-model="drawer2" title="I am the title" :with-header="false">
          <el-form ref="form" :model="details2">
            ...
            <el-form-item label="请假类型：">
              <el-input v-model="details2[0].leaveType" disabled></el-input>
            </el-form-item>
            <el-form-item label="请假事由：">
            ...
            <el-form-item label="请假结束时间：">
              <el-input v-model="details2[0].leaveedate" disabled></el-input>
            </el-form-item>
            <el-form-item label="请假总时长：">
              <el-input v-model="details2[0].leavetotaldate" disabled></el-input>
            </el-form-item>
            <el-form-item label="当前审核状态：">
        ...
        <div class="demo-pagination-block">
          <el-pagination v-model:current-page="pageInfo1.currentPage"
                         ...
                         next-text="下一页"
                         prev-text="上一页"
                         @size-change="selectEndLeaveAll()"
                         @current-change="selectEndLeaveAll()"
                         @prev-click="selectEndLeaveAll()"
                         @next-click="selectEndLeaveAll()">
          </el-pagination>
        </div>
      </el-tab-pane>
    </el-tabs>
...
export default {
  ...
  methods: {
    ...
    selectEndLeaveAll() {
      ...
      this.axios({
        method: 'post',
        url: this.url + 'selectEndLeaveAll',
        data: {
          //当前页
    ...
    particulars(value) {
      ...
      this.axios({
        method: 'post',
        url: this.url + 'selectDetailsLeaves',
        data: {
          //审批编号
