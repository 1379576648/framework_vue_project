  ...
  <div class="body_1">
    <el-tabs type="border-card">
      ...
      <el-tab-pane label="待办申请">
        <el-button @click="selectTravelAll2()">重置</el-button>
        &nbsp;
        <el-input
            v-model="staffName"
            placeholder="根据申请人搜索"
        ...
        &nbsp;
        <el-button type="success" plain @click="selectTravelAll()">搜索</el-button>
        <!--  表格 -->
        <el-table
            ref="filterTable1"
            row-key="date1"
        ...
        <div class="demo-pagination-block">
          <el-pagination
              ...
              next-text="下一页"
              prev-text="上一页"
              @size-change="selectTravelAll()"
              @current-change="selectTravelAll()"
              @prev-click="selectTravelAll()"
              @next-click="selectTravelAll()">
            prev-text="上一页"
            next-text="下一页"
            >
      ...
      <el-drawer v-model="drawer" title="I am the title" :with-header="false">
        <el-form ref="form" :model="details">
          ...
          <el-form-item label="出差地点：">
            <el-input v-model="details[0].travelplace" disabled></el-input>
          </el-form-item>
          <el-form-item label="出差事由：">
            <el-input v-model="details[0].travelmatter" disabled></el-input>
          </el-form-item>
          <el-form-item label="出差开始时间：">
            <el-input v-model="details[0].travelsdate" disabled></el-input>
          </el-form-item>
          <el-form-item label="出差结束时间：">
            <el-input v-model="details[0].traveledate" disabled></el-input>
          </el-form-item>
          <el-form-item label="出差总时长：">
            <el-input v-model="details[0].traveltotaldate" disabled></el-input>
          </el-form-item>
      ...
      <el-tab-pane label="已办申请">
        <el-button @click="selectEndTravelAll2()">重置</el-button>
        &nbsp;
        <el-input
            v-model="staffName1"
            placeholder="根据申请人搜索"
        ...
        &nbsp;
        <el-button type="success" plain @click="selectEndTravelAll()">搜索</el-button>
        <el-table
            ref="filterTable"
            row-key="date"
            :data="tableData1"
        ...
        <el-drawer v-model="drawer2" title="I am the title" :with-header="false">
          <el-form ref="form" :model="details2">
            ...
            <el-form-item label="出差地点：">
              <el-input v-model="details2[0].travelplace" disabled></el-input>
            </el-form-item>
            <el-form-item label="出差事由：">
              <el-input v-model="details2[0].travelmatter" disabled></el-input>
            </el-form-item>
            <el-form-item label="出差开始时间：">
              <el-input v-model="details2[0].travelsdate" disabled></el-input>
            </el-form-item>
            <el-form-item label="出差结束时间：">
              <el-input v-model="details2[0].traveledate" disabled></el-input>
            </el-form-item>
            <el-form-item label="出差总时长：">
              <el-input v-model="details2[0].traveltotaldate" disabled></el-input>
            </el-form-item>
            <el-form-item label="当前审核状态：">
        ...
        <div class="demo-pagination-block">
          <el-pagination v-model:current-page="pageInfo1.currentPage"
                         ...
                         next-text="下一页"
                         prev-text="上一页"
                         @size-change="selectEndTravelAll()"
                         @current-change="selectEndTravelAll()"
                         @prev-click="selectEndTravelAll()"
                         @next-click="selectEndTravelAll()">
          </el-pagination>
        </div>
      </el-tab-pane>
    </el-tabs>
...
export default {
  ...
  methods: {
    ...
    selectEndTravelAll() {
      ...
      this.axios({
        method: 'post',
        url: this.url + 'selectEndTravelAll',
        data: {
          //当前页
