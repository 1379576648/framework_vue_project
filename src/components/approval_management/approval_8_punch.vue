  ...
  <div class="body_1">
    <el-tabs type="border-card">
      ...
      <el-tab-pane label="待办申请">
        <el-button @click="selectCardAll2()">重置</el-button>
        &nbsp;
        <el-input
            v-model="staffName"
            placeholder="根据申请人搜索"
        ...
        &nbsp;
        <el-button type="success" plain @click="selectCardAll()">搜索</el-button>
        <!--  表格 -->
        <el-table
            ref="filterTable1"
            row-key="date1"
        ...
        <div class="demo-pagination-block">
          <el-pagination
              ...
              next-text="下一页"
              prev-text="上一页"
              @size-change="selectCardAll()"
              @current-change="selectCardAll()"
              @prev-click="selectCardAll()"
              @next-click="selectCardAll()">
            prev-text="上一页"
            next-text="下一页"
            >
      ...
      <el-drawer v-model="drawer" title="I am the title" :with-header="false">
        <el-form ref="form" :model="details">
          ...
          <el-form-item label="补打卡类型：">
            <el-input v-model="details[0].cardtype" disabled></el-input>
          </el-form-item>
          <el-form-item label="补打卡时间：">
            <el-input v-model="details[0].carddate" disabled></el-input>
          </el-form-item>
          <el-form-item label="备注：">
            <el-input v-model="details[0].cardremarks" disabled></el-input>
          </el-form-item>
      ...
      <el-tab-pane label="已办申请">
        <el-button @click="selectEndCardAll2()">重置</el-button>
        &nbsp;
        <el-input
            v-model="staffName1"
            placeholder="根据申请人搜索"
        ...
        &nbsp;
        <el-button type="success" plain @click="selectEndCardAll()">搜索</el-button>
        <el-table
            ref="filterTable"
            row-key="date"
            :data="tableData1"
        ...
        <el-drawer v-model="drawer2" title="I am the title" :with-header="false">
          <el-form ref="form" :model="details2">
            ...
            <el-form-item label="补打卡类型：">
              <el-input v-model="details2[0].cardtype" disabled></el-input>
            </el-form-item>
            <el-form-item label="补打卡时间：">
              <el-input v-model="details2[0].carddate" disabled></el-input>
            </el-form-item>
            <el-form-item label="备注：">
              <el-input v-model="details2[0].cardremarks" disabled></el-input>
            </el-form-item>
            <el-form-item label="当前审核状态：">
        ...
        <div class="demo-pagination-block">
          <el-pagination v-model:current-page="pageInfo1.currentPage"
                         ...
                         next-text="下一页"
                         prev-text="上一页"
                         @size-change="selectEndCardAll()"
                         @current-change="selectEndCardAll()"
                         @prev-click="selectEndCardAll()"
                         @next-click="selectEndCardAll()">
          </el-pagination>
        </div>
      </el-tab-pane>
    </el-tabs>
...
export default {
  ...
  methods: {
    ...
    particulars(value) {
      ...
      this.axios({
        method: 'post',
        url: this.url + 'selectDetailsCards',
        data: {
          //审批编号
