  ...
  <div class="body_1">
    <el-tabs type="border-card">
      ...
      <el-tab-pane label="待办申请">
        <el-button @click="selectQuitAll2()">重置</el-button>
        &nbsp;
        <el-input
            v-model="staffName"
            placeholder="根据申请人搜索"
        ...
        &nbsp;
        <el-button type="success" plain @click="selectQuitAll()">搜索</el-button>
        <!--  表格 -->
        <el-table
            ref="filterTable1"
            row-key="date1"
        ...
        <div class="demo-pagination-block">
          <el-pagination
              ...
              next-text="下一页"
              prev-text="上一页"
              @size-change="selectQuitAll()"
              @current-change="selectQuitAll()"
              @prev-click="selectQuitAll()"
              @next-click="selectQuitAll()">
            prev-text="上一页"
            next-text="下一页"
            >
      ...
      <el-drawer v-model="drawer" title="I am the title" :with-header="false">
        <el-form ref="form" :model="details">
          ...
          <el-form-item label="离职类型：">
            <el-input v-model="details[0].quitType" disabled></el-input>
          </el-form-item>
          <el-form-item label="离职说明：">
            <el-input v-model="details[0].quitexplain" disabled></el-input>
          </el-form-item>
          <el-form-item label="申请离职日期：">
            <el-input v-model="details[0].applyquitdate" disabled></el-input>
          </el-form-item>
      ...
      <el-tab-pane label="已办申请">
        <el-button @click="selectEndQuitAll2()">重置</el-button>
        &nbsp;
        <el-input
            v-model="staffName1"
            placeholder="根据申请人搜索"
        ...
        &nbsp;
        <el-button type="success" plain @click="selectEndQuitAll()">搜索</el-button>
        <el-table
            ref="filterTable"
            row-key="date"
            :data="tableData1"
        ...
        <el-drawer v-model="drawer2" title="I am the title" :with-header="false">
          <el-form ref="form" :model="details2">
            ...
            <el-form-item label="离职类型：">
              <el-input v-model="details2[0].quitType" disabled></el-input>
            </el-form-item>
            <el-form-item label="离职说明：">
              <el-input v-model="details2[0].quitexplain" disabled></el-input>
            </el-form-item>
            <el-form-item label="申请离职日期：">
              <el-input v-model="details2[0].applyquitdate" disabled></el-input>
            </el-form-item>
            <el-form-item label="当前审核状态：">
        ...
        <div class="demo-pagination-block">
          <el-pagination v-model:current-page="pageInfo1.currentPage"
                         ...
                         next-text="下一页"
                         prev-text="上一页"
                         @size-change="selectEndQuitAll()"
                         @current-change="selectEndQuitAll()"
                         @prev-click="selectEndQuitAll()"
                         @next-click="selectEndQuitAll()">
          </el-pagination>
        </div>
      </el-tab-pane>
    </el-tabs>
...
export default {
  ...
  methods: {
    ...
    particulars(value) {
      ...
      this.axios({
        method: 'post',
        url: this.url + 'selectDetailsQuit',
        data: {
          //审批编号
